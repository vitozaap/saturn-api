...
export class CompressionResponseDto {
    ...
    @ApiProperty({
        type: String,
        nullable: true,
        description: "Source size in bytes. BigInt serialized as a string.",
        example: "9000000000",
    })
    ...
    @ApiProperty({
        type: String,
        nullable: true,
        description: "Output size in bytes. BigInt serialized as a string.",
        example: "3000000000",
    })
    ...
    @ApiProperty({
        type: Number,
        nullable: true,
        description: "Derived outputSize / sourceSize, never stored.",
        example: 0.33,
    })
    ratio: number | null
